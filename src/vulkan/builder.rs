...
impl SwapchainBuilder {
    pub unsafe fn new(entry: Arc<ash::Entry>, device: Arc<ash::Device>, instance: Arc<ash::Instance>, physical: vk::PhysicalDevice, allocator: Arc<vk_mem::Allocator>, window: Arc<winit::window::Window>, surface_loader: Option<(Arc<surface::Instance>, vk::SurfaceKHR)>) -> SwapchainBuilder {
        let s = {
